...
//
// Мітка "нове" — БЕЗ дати. Показується автоматично на уроці, який
// стоїть ОСТАННІМ у масиві LESSONS для свого класу. Тому нові уроки
// завжди дописуй В КІНЕЦЬ масиву (не встав усередину) — щойно
// додаси наступний урок цього класу, мітка сама "переїде" на нього.
//
